...
import { GhostPortfolioPanel } from './GhostPortfolioPanel';
                        ...
                        <>
                            <header className="content-header">
                                <div className="wallet-display">
                                    ...
                                    <h2>
                                        {selectedWallet.label}
                                        {selectedWallet.ghostMode && <span className="ghost-badge">👻</span>}
                                    </h2>
                                    <span className="wallet-address">{selectedWallet.address}</span>
                                </div>
                                <div className="header-actions">
                                    {selectedWallet.ghostMode && (
                                        <button
                                            className={`btn-ghost-view ${showGhostPanel ? 'active' : ''}`}
                            ...
                            {showGhostPanel && selectedWallet.ghostMode && (
                                <GhostPortfolioPanel
